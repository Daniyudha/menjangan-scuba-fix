            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-left">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-slate">Explore the mysteries of the ocean and dive into a world full of wonders.</p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {services.map((service, index) => ( <li key={index}><span className="text-slate">{service}</span></li> ))}
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-slate">
                            <li>+62 821-9898-4623</li>
                            <li>info@menjanganscuba.com</li>
                            <li>Menjangan Island, Bali, Indonesia</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mt-16 border-t border-light-navy/20 pt-8 flex flex-col md:flex-row justify-between items-center text-center text-sm text-slate">
                    ...
                    {/* <div className="mt-4 md:mt-0">
                        <Link href="/privacy-policy" className="hover:text-bright-blue transition-colors">Privacy Policy</Link>
                        <span className="mx-2">|</span>
                        <Link href="/terms-of-service" className="hover:text-bright-blue transition-colors">Terms of Service</Link>
                    </div> */}
                </div>
            </div>
        </footer>
