...
async function main() {
  ...
  for (const pkg of mockDb.packages) {
    await prisma.package.create({ 
      data: {
        ...
        inclusions: pkg.inclusions as unknown as Prisma.JsonArray,
      } 
    });
  }
  ...
  await prisma.setting.create({
    data: {
      ...
      hero: mockDb.settings.hero as unknown as Prisma.JsonArray,
      experience: mockDb.settings.experience as unknown as Prisma.JsonObject,
      socialLinks: mockDb.settings.socialLinks as unknown as Prisma.JsonObject,
    },
  });
